...
export default function HREmployees() {
  ...
  const { data: employees, isLoading } = useQuery<Employee[]>({
    queryKey: ['hr-employees', search, deptFilter],
  ...
  const { data: archivedEmployees, isLoading: archivedLoading } = useQuery<Employee[]>({
    queryKey: ['hr-employees-archived', search, deptFilter],
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['hr-employees'] }); toast.success('Employee updated.'); closeModal(); },
  ...
  const toggleMutation = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['hr-employees'] }); toast.success('Status updated.'); },
  });
